...
int main(int argc, const char * argv[]) {
    @autoreleasepool {
		...
		*/
		...
		// GOLD CHALLENGE
		BNRContainer *container = [[BNRContainer alloc] initWithItemName:@"Tub"
														  valueInDollars:10
															 listOfItems:items];
		
		NSLog(@"%@", container);
		NSLog(@"%@'s worth: $%@", container.itemName, [container containerSum]);
		NSLog(@"%@'s items: \n%@", container.itemName, container.subitems);
